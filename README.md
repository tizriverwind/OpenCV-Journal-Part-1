...
Interestingly, ksize and sigmaX are interdependent. Typically sigma = 0.3*((ksize-1)*0.5 - 1) + 0.8 or we can set sigma X to 0 so OpenCV would automatically calculate the proper value based on given kernel size.
